...
// serve static client files (index.html, avatar.html, etc.)
...
app.post('/api/upload', (req, res) => {
  ...
  // TODO: store or process these as you like
  console.log('Received upload:', { conversationId, resumeText, jdText });
